                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('storeTeam') }}" method="POST" enctype="multipart/form-data">
                             @csrf
                                ...
                                <input type="text" class="form-control" name="teammember_name" id="text" placeholder="Enter Team Mate Name">
                                <input name="_method" type="hidden" value="POST">
                                <label for="text">Add Team  Designation</label>
                                <textarea type="text" class="form-control" name="teammember_designation" id="editor" placeholder="Enter Tender Designation"> </textarea>
                                
                                <label for="text">Choose Team Image</label>
                                <input type="file" class="form-control" name="teammember_image">
                            </div>
                            </div> 
                        </div>
                    </div>
