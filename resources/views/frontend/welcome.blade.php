                ...
                <div class="col-12 col-md-4 p-0">
                    <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                        <a class="nav-link feature_link" id="v-pills-home-tab" data-toggle="pill" href="#v-pills-home" role="tab" aria-controls="v-pills-home" aria-selected="true">
                            ...
                            <p><span>Construction & Consultancy</span>The Best Consultancy Agencies in Country</p>
                        </a>
        ...
        <div class="container">
            ...
            <div class="row slick-screen mt-5">
                <div class="col-12 col-lg-12">
                    <img src="{{ asset('/') }}frontend/images/screenshot_1.jpg" class="img-fluid" alt="">
                </div>
                <div class="col-12 col-lg-12">
                    <img src="{{ asset('/') }}frontend/images/screen_shot_2.jpg" class="img-fluid" alt="">
                </div>
                <div class="col-12 col-lg-12">
                    <img src="{{ asset('/') }}frontend/images/screenshot_3.jpg" class="img-fluid" alt="">
                </div>
                <div class="col-12 col-lg-12">
                    <img src="{{ asset('/') }}frontend/images/screen_shot_4.jpg" class="img-fluid" alt="">
                </div>
                <div class="col-12 col-lg-12">
                    <img src="{{ asset('/') }}frontend/images/screen_shot_5.jpg" class="img-fluid" alt="">
                </div>
                <div class="col-12 col-lg-12">
                    <img src="{{ asset('/') }}frontend/images/screen_shot_6jpg.jpg" class="img-fluid" alt="">
                </div>
            ...
            <div class="row team-slick mt-5">
                <div class="col-md-12">
                    <div class="team-member ">
                        ...
                        <div class="team-txt text-center py-2">
                            ...
                            <h3>Developer</h3>
                            <p>
                                Nuhash Naimul is Hardworking rison. He never ummy text of the prining and typesetting industry.
                            </p>
                        </div>
                    </div>
                </div>
                <div class="col-md-12">
                    <div class="team-member">
                        ...
                        <div class="team-txt text-center py-2">
                            ...
                            <h3>developer</h3>
                            <p>
                                Md. Masum is Hardworking rson. She never ummy text of the prining and typesetting industry.
                            </p>
                        </div>
                    </div>
                </div>
                <div class="col-md-12">
                    <div class="team-member">
                        ...
                        <div class="team-txt text-center py-2">
                            <h2>Mahbub Alam Rakibee</h2>
                            <h3>developer</h3>
                            <p>
                                Mahbub Alam Rakibee is Hardworking rson. He never ummy text of the prining and typesetting industry.
                            </p>
                        </div>
                    </div>
                </div>
